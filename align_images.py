...
if __name__ == "__main__":
    ...
    parser.add_argument('raw_dir', default="./raw_dir", help='Directory with raw images for face alignment')
    parser.add_argument('aligned_dir', default="./aligned_dir", help='Directory for storing aligned images')
